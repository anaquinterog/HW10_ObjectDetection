...
def run_pipeline(video_path, img_obj_path):
    ...
    image = orb.initialize_orb(img_obj_path)

    ref_kp, ref_desc = orb.detect_and_compute(image, img_obj_path)
    ...
    while True:
        ...
        orbs = orb.detect_features(orbs)
        frame_kp, frame_desc = orb.detect_and_compute(orbs, vertical_frame)
